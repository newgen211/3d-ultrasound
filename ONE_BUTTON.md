...
`pyclariuscast.so`, 12.2.0 aarch64 python310) are not in git; they sit in the Pi repo dir.
...
1. **Headless capture, 10 s, probe awake, no arm.** On the Pi:
   `cd ~/Documents/ultrasound-cobot && python3.10 cast_headless.py --section 900 --ip 192.168.1.1 --port 5828 --seconds 10`
