#!/usr/bin/env python3
"""
us3d.tube — find AND track the anechoic vessel in B-mode (texture-aware)
...
(a wrong point plants an outlier; a miss just gets bridged by smoothing).
    ...
    python3 src/us3d/tube.py            # latest section
    python3 src/us3d/tube.py section_50
...
# Re-exported so existing callers keep working: `from us3d.tube import
# load_frame, to_u8, find_section` and the segment_tube compatibility shim.
from us3d.frames import load_frame, to_u8  # noqa: F401
from us3d.sections import find_section  # noqa: F401
