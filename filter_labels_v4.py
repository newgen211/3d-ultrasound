...
Reads sam_detections_v2.json, writes sam_detections_v4.json. Pure numpy."""
import json, sys
...
for sec_name in sys.argv[1:]:
    ...
    dd = json.loads((sec / "sam_detections_v2.json").read_text())
    dets = dd["detections"]
    ...
    (sec / "sam_detections_v4.json").write_text(json.dumps(out))
